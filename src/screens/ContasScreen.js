...
const tiposConta = ['Conta Corrente', 'Conta Poupanâ”œÂºa', 'Carteira', 'Cartâ”œÃºo de Crâ”œÂ®dito', 'Investimentos', 'Outros'];
...
export default function ContasScreen({ navigation }) {
  ...
  const handleDelete = (id) => {
    ...
    if (!id || id === 'undefined' || id === 'null') {
      Alert.alert('Erro', 'ID da conta invâ”œÃ­lido');
      console.error('ID invâ”œÃ­lido para deletar conta:', id);
      return;
    }
        ...
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              fetchContas();
              Alert.alert('Sucesso', 'Conta excluâ”œÂ¡da com sucesso');
            } catch (err) {
